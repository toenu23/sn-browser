var NRS = (function (NRS, $, undefined) {
    ...
    NRS.isJay = false;
    var server = ""; /*http://localhost:7876*/
    ...
    NRS.getServerIP = function (result) {
        ...
        if (server) {
            ...
            $.ajax({
                ...
                error: function (data) {
                    if (hasUserServer) {
                        $.growl("Server " + server + " doesn't have CORS enabled!", { "type": "danger" });
                    }
    ...
    NRS.onSuccessGetServer = function (tries) {
        ...
        NRS.sendRequest("getBlockchainStatus", {
            ...
            $("#node_ip").val(NRS.server.substring(NRS.server.lastIndexOf("/") + 1, NRS.server.lastIndexOf(":")));
